...
<body>
    ...
    <div id="user">
        ...
        <img class="logo" src="imagens/logo.jpg" alt="logo" width="50px"> Sistema WM Projetos
    </header>
    ...
    <div id="formulario">
        ...
        <div id="textoCadastro">
            ...
            <span class="subtitle">Crie uma conta agora para acessar todas as ferramentas.</span>
